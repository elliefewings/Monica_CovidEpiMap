...
#Write scores
write.csv(am.p$scores, "dorothea/dorothea_am_scores.csv")
write.csv(as.p$scores, "dorothea/dorothea_as_scores.csv")
write.csv(h.p$scores, "dorothea/dorothea_h_scores.csv")
write.csv(rm.p$scores, "dorothea/dorothea_rm_scores.csv")
write.csv(rs.p$scores, "dorothea/dorothea_rs_scores.csv")
write.csv(alldata$scores, "dorothea/dorothea_all_scores.csv")

#Create heatmap names
all.h <- "dorothea/heatmap_allconditions.pdf"
am.h <- "dorothea/heatmap_am.pdf"
as.h <- "dorothea/heatmap_as.pdf"
h.h <- "dorothea/heatmap_h.pdf"
rm.h <- "dorothea/heatmap_rm.pdf"
rs.h <- "dorothea/heatmap_rs.pdf"
